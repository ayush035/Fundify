...
async function getFlowns(url){
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Fundify</title>
        <meta name="description" content="Fundify" />
...
height="400"/>
      ...
      <p>You have not registered any FNS Grants yet</p>
            ...
            <div
              className="block max-w-sm rounded-sm bg-gray-200 cursor-pointer font-mono text-black hover:bg-gray-300" key={idx}>
              ...
              <div className="p-6 ease-in-out delay-100 hover:-translate-y-1">
                <h5
                  className="mb-2 text-xl  text-black font-semibold">
                {di.name}
                </h5>
                <p className="mb-1 text-black ">
                  <p className="text-black" onMouseEnter={ async ()=>{ 
