...
//   }
  ...
  return (
    <>
     <nav className=' flex justify-between h-12 text-black bg-gwhite   font-bold' >
        <span className='mx-20 my-2 flex text-black text-2xl	'><Link href={"/"}>FUNDIFY</Link></span>
...
<div className='hover:-translate-y-1  text-md font-semibold font-mono '>
      <Link href="/">Home</Link></div>
<div className='hover:-translate-y-1 delay-50  text-md font-semibold font-mono'>
...
<div className=' text-md font-semibold bg-gray-300 text-black rounded-lg px-3 font-mono' >
